  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      <div class="row justify-content-center">
          <div class="col-lg-6" style="color:#D2F015 ;">
              <!-- <h1 class="mt-4 mb-3" style="color:s#D2F015 ;">
      ...
      <div class="card" style="height:250px; background-image:url('admin_image/glossy1.jpg'); margin-left:250px;margin-right:250px">
          <div class="card-body">
